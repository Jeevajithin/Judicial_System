...
$result2_d=$con->query($sql2_d);
					...
					<div align="right">
						...
						<a href="schedule_hearing_judge.php?case_id=<?php echo $case_id; ?>&hearing_id=<?php echo $hearing_id; ?>" style="background-color: #aa9166; color: black;padding: 8px; margin-left: 5px; border-radius: 5px">Update Hearing and Schedule Next</a>
						
						<a href="add_final_judgement.php?case_id=<?php echo $case_id; ?>" style="background-color: #aa9166; color: black;padding: 8px; margin-left: 5px; border-radius: 5px">Close Case & Add Final Judgement</a></div>
					<p>&nbsp;</p>
					<?php
